...
#include "DBOXDetectorMessenger.hh"
...
DBOXDetectorMessenger::DBOXDetectorMessenger(DBOXDetectorConstruction* det)
:   G4UImessenger(), 
    fDBOXDetector(det),
    fDirCMD(nullptr), 
...
DBOXDetectorMessenger::~DBOXDetectorMessenger() {
