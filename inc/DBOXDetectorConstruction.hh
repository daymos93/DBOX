...
#ifndef DBOXDETECTORCONTRUCTION_HH
#define DBOXDETECTORCONTRUCTION_HH

#include "G4VUserDetectorConstruction.hh"

// forward declaration
//class DBOXDetectorMessenger;  //clase para el DetectorConstruction user control
class G4Material;
class G4String;
class G4LogicalVolume;

class DBOXDetectorConstruction : public G4VUserDetectorConstruction {

  // Method declaration:
  public:

    // CTR & DTR 
    DBOXDetectorConstruction();
    virtual ~DBOXDetectorConstruction();
...
//    DBOXDetectorMessenger* fDetMessenger;
