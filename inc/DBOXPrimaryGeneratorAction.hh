...
#ifndef DBOXPRIMARYGENERATORACTION_HH
#define DBOXPRIMARYGENERATORACTION_HH
...
class DBOXPrimaryGeneratorAction : public G4VUserPrimaryGeneratorAction {

  // Method declaration:
  public:
    
    // CTR & DTR
	DBOXPrimaryGeneratorAction(DBOXDetectorConstruction* det);
    virtual ~DBOXPrimaryGeneratorAction();
