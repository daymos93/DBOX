...
#ifndef DBOXACTIONINITIALIZATION_HH
#define DBOXACTIONINITIALIZATION_HH
...
class DBOXActionInitialization : public G4VUserActionInitialization {

  // Method declaration:
  public:
    
    // CTR & DTR (you will need to talk to your detector to find out the GUN pos.)
	DBOXActionInitialization(DBOXDetectorConstruction* det);
    virtual ~DBOXActionInitialization();
